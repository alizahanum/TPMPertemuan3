...
public class dataPahlawan extends modelPahlawan {
    ...
    public static ArrayList<modelPahlawan> getListData(){
        ...
        for (int i=0; i<heroNames.length;i++){
            ...
            modelPahlawan.setHeroDetails(heroDetails[i]);
            modelPahlawan.setHeroesImages(heroesImages[i]);
            modelPahlawan.setHeroNames(heroNames[i]);
