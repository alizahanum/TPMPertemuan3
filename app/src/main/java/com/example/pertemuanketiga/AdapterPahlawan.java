...
public class AdapterPahlawan extends RecyclerView.Adapter<AdapterPahlawan.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        btndetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("deskripsi", getModelPahlawan().get(position).heroDetails);
                intent.putExtra("judul", getModelPahlawan().get(position).heroNames);
    ...
    public ArrayList<com.example.pertemuanketiga.modelPahlawan> getModelPahlawan() {
        return modelPahlawan;
    }

    public void setModelPahlawan(ArrayList<com.example.pertemuanketiga.modelPahlawan> modelPahlawan) {
